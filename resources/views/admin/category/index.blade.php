        ...
        <table class="table s7__table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$data->name}}</td>
                    <td><img id="image-preview" class="img-fluid"
                        src="{{ asset('public/images/icon/' . $data->icon) }}"
                        alt="image" width="28" /></td>
                    <td>
                        @if ($data->status == 1)
                        ...
                        {!! Form::model($data, ['method' => 'PATCH','route' => ['category.update', $data->id], 'enctype' => 'multipart/form-data']) !!}
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::file('icon', ['id' => 'file-input', 'class' => 'form-control']) !!}
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            <div id='img_contain'>
        ...
        {!! Form::open(array('route' => 'category.store', 'method'=>'POST', 'enctype' => 'multipart/form-data')) !!}
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::file('icon', array('id' => 'file-input3', 'class' => 'form-control', 'required')) !!}
                            <div class="row mt-2">
                                <div class="col-md-12">
                                    <div id='img_contain'>
