                ...
                <div class="col-lg-8">
                    <div class="blog-details-page-content pb-0">
                        <div class="single-blog-inner">
                            <div class="thumb">
                                <img class="news_fontimg_size" src="{{ asset('public/images/blog/' . @$news->image) }}"
                                    alt="img">
                            </div>
                            <div class="details">
                                <ul class="blog-meta">
                                ...
                                <h3 class="title text-white">{{ @$news->title }}</h3>
                                <p>{!! @$news->description !!}</p>
                                <div class="blog-share-area">
                                    <h4 class="text-white mb-0">Share post</h4>
                                    <ul>
                                        ...
                                        <li><a href="https://plus.google.com/share?url={{ urlencode(url()->current()) }}"
                    ...
                    <div class="blog-comment">
                        ...
                        <script>
                            (function(d, s, id) {
                                ...
                                js.id = id;
                                js.src = "//connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v2.8&appId=1421567158073949";
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <img class="news_img_size"
                                                    src="{{ asset('public/images/blog/' . $data->image) }}" alt="img">
                                            </div>
                                            <div class="media-body align-self-center">
                                                <h6 class="title"><a
                                                        href="{{ route('frontend.newsDetails', [$data->slug, $data->id]) }}">{{ $data->title }}
                                                    </a></h6>
