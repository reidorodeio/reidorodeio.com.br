        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog-inner-2">
                    ...
                    <div class="details">
                        <h5><a href="{{route('frontend.newsDetails',[$data->slug, $data->id])}}">{{$data->title}}</a></h5>
                        <ul class="meta">
                            <li class="user"><i class="far fa-user"></i> Admin</li>
                            <li class="date"><i class="far fa-clock"></i> {{$data->created_at->diffForHumans()}}</li>
                        </ul>
                        <p class="content">{{ short_text($data->description, 10) }}</p>
                        <a class="read-more-text" href="{{route('frontend.newsDetails',[$data->slug, $data->id])}}">Leia Mais <i class="fa fa-angle-right ms-2"></i></a>
                    </div>
                </div>
            </div>
            @endforeach
