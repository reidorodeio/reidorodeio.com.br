...
return [
    ...
    */
    ...
    | especificar uma linha de idioma personalizada específica para uma regra de atributo fornecida.
    |
    */
    ...
    | com algo mais legível, como "Endereço de E-Mail" em vez de "email". Isso ajuda a tornar nossa mensagem mais expressiva.
    |
    */
