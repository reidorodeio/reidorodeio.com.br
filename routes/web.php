...
use App\Http\Controllers\Admin\BolaoController;
use App\Http\Controllers\Admin\PointsController;
use App\Http\Controllers\Admin\RankingController;
use App\Http\Controllers\FrontendBolaoController;
...
Route::get('/', 'UiController@index')->name('frontend.layouts.partials.inside');
...
Route::get('/auth', [UnifiedAuthController::class, 'showAuthForm'])->name('auth.form');
...
Route::post('/auth/logout', [UnifiedAuthController::class, 'logout'])->name('auth.logout');
...
Route::group(['middleware' => ['auth', 'ckstatus'], 'namespace' => 'User'], function () {
    ...
    // Rotas para equipes e eventos
    Route::get('/create-team/{event}', [TeamController::class, 'create'])->name('create.team');
    Route::get('/boloeseventos/{event_id}/{category}', [FrontendBolaoController::class, 'show'])->name('frontend.boloes');
    Route::get('/bolao/{bolao_id}/criar-equipe', [BolaoController::class, 'createTeam'])->name('frontend.boloes.createTeam');
    Route::get('/bolao/{bolao_id}/create-team', [TeamController::class, 'create'])->name('teams.create');
    Route::post('/bolao/{bolao_id}/store-team', [TeamController::class, 'store'])->name('teams.store');
    Route::get('/teams', [TeamController::class, 'index'])->name('teams.index');

    // Perfil do Usuário
    Route::get('profile-setting', 'HomeController@index')->name('profile.index');
    Route::post('profile-setting', 'HomeController@profileUpdate')->name('profile.update');

    // Atualizar foto de perfil
    Route::post('/user/photo', 'HomeController@updatePhoto')->name('profile.update.photo');
    ...
    Route::get('general-ranking', 'RankingController@general')->name('general.ranking');

    // Rota de sucesso após criação da equipe
    Route::get('/teams/success', function () {
        return view('frontend.boloes.success');
    })->name('teams.success');

    // Fantasy
    Route::get('/fantasy', 'FantasyController@index')->name('frontend.index');
});
...
Route::group(['middleware' => ['auth:admin'], 'prefix' => 'admin', 'namespace' => 'Admin'], function () {
    ...
    Route::get('/fantasy/teams', 'TeamController@index')->name('admin.fantasy.teams.index');
    Route::get('/fantasy/teams/create', 'TeamController@create')->name('admin.fantasy.teams.create');
    Route::post('/fantasy/teams', 'TeamController@store')->name('admin.fantasy.teams.store');
    Route::get('/fantasy/teams/edit/{id}', 'TeamController@edit')->name('admin.fantasy.teams.edit');
    Route::post('/fantasy/teams/update/{id}', 'TeamController@update')->name('admin.fantasy.teams.update');
    Route::post('/fantasy/teams/delete/{id}', 'TeamController@destroy')->name('admin.fantasy.teams.delete');
    Route::resource('competitors', CompetitorController::class);
    Route::get('/fantasy/competitors', 'CompetitorController@index')->name('admin.fantasy.competitors.index');
    Route::get('/fantasy/competitors/create', 'CompetitorController@create')->name('admin.fantasy.competitors.create');
    Route::post('/fantasy/competitors', 'CompetitorController@store')->name('admin.fantasy.competitors.store');
    Route::get('/fantasy/competitors/edit/{id}', 'CompetitorController@edit')->name('admin.fantasy.competitors.edit');
    Route::post('/fantasy/competitors/update/{id}', 'CompetitorController@update')->name('admin.fantasy.competitors.update');
    Route::post('/fantasy/competitors/delete/{id}', 'CompetitorController@destroy')->name('admin.fantasy.competitors.delete');
    Route::get('/competitors/edit/{id}', 'CompetitorController@edit')->name('admin.fantasy.competitors.edit');
    Route::get('/admin/competitors/edit/{id}', 'CompetitorController@edit')->name('admin.fantasy.competitors.edit');
    Route::post('/admin/competitors/update/{id}', 'CompetitorController@update')->name('admin.fantasy.competitors.update');
    Route::get('/fantasy/events', 'FantasyEventController@index')->name('admin.fantasy.events.index')->middleware('can:event-index');
    Route::get('/fantasy/events/create', 'FantasyEventController@create')->name('admin.fantasy.events.create')->middleware('can:event-create');
    Route::post('/fantasy/events', 'FantasyEventController@store')->name('admin.fantasy.events.store')->middleware('can:event-create');
    Route::get('/fantasy/events/edit/{id}', 'FantasyEventController@edit')->name('admin.fantasy.events.edit')->middleware('can:event-edit');
    Route::put('/fantasy/events/update/{id}', 'FantasyEventController@update')->name('admin.fantasy.events.update')->middleware('can:event-edit'); // Alterado para PUT
    Route::delete('/fantasy/events/delete/{id}', 'FantasyEventController@destroy')->name('admin.fantasy.events.delete')->middleware('can:event-delete');
    Route::get('/fantasy/boloens', [BolaoController::class, 'index'])->name('admin.fantasy.boloens.index');
    Route::get('/fantasy/boloens/create', [BolaoController::class, 'create'])->name('admin.fantasy.boloens.create');
    Route::post('/fantasy/boloens', [BolaoController::class, 'store'])->name('admin.fantasy.boloens.store');
    Route::get('/fantasy/boloens/edit/{id}', [BolaoController::class, 'edit'])->name('admin.fantasy.boloens.edit');
    Route::put('/fantasy/boloens/update/{id}', [BolaoController::class, 'update'])->name('admin.fantasy.boloens.update');
    Route::post('/fantasy/boloens/delete/{id}', [BolaoController::class, 'destroy'])->name('admin.fantasy.boloens.delete');
    Route::get('/fantasy/rankings', [RankingController::class, 'index'])->name('admin.fantasy.rankings.index');
    Route::get('/fantasy/rankings/create', [RankingController::class, 'create'])->name('admin.fantasy.rankings.create')->middleware('can:admin.rankings.create');
    Route::post('/fantasy/rankings', [RankingController::class, 'store'])->name('admin.fantasy.rankings.store')->middleware('can:admin.rankings.store');
    Route::get('/fantasy/rankings/edit/{id}', [RankingController::class, 'edit'])->name('admin.fantasy.rankings.edit')->middleware('can:admin.rankings.edit');
    Route::put('/fantasy/rankings/update/{id}', [RankingController::class, 'update'])->name('admin.fantasy.rankings.update')->middleware('can:admin.rankings.update');
    Route::delete('/fantasy/rankings/delete/{id}', [RankingController::class, 'destroy'])->name('admin.fantasy.rankings.delete')->middleware('can:admin.rankings.delete');
    Route::get('/admin/points/{event_id}/competitors', [PointsController::class, 'showCompetitors'])->name('admin.points.competitors');
    Route::post('/competitor/update-points', [PointsController::class, 'updatePoints'])->name('competitor.updatePoints');
    Route::post('/ranking/update', [RankingController::class, 'update'])->name('ranking.update');
    Route::get('/admin/points', [PointsController::class, 'index'])->name('admin.points.index');
    ...
    Route::group(['middleware' => 'permission'], function () {
        ...
        Route::post('admin/points/{competitor_id}/points', [PointsController::class, 'updatePoints'])->name('admin.points.points');
        ...
        Route::get('users', 'AdminUserController@usersIndex')->name('admin.user.manage');
        Route::get('users/detail/{id}', 'AdminUserController@indexUserDetail')->name('user.view');
        Route::put('users/update/{id}', 'AdminUserController@userUpdate')->name('user.detail.update');
        Route::get('active-user', 'AdminUserController@usersActiveIndex')->name('active.user.manage');
        Route::get('ban-user', 'AdminUserController@usersBanndedIndex')->name('ban.user.manage');
        Route::get('user/email-unverified', 'AdminUserController@usersUnverifiedIndex')->name('email.unverified.user');
        Route::GET('user/search', 'AdminUserController@userSearch')->name('username.search');
        Route::GET('user/search/email', 'AdminUserController@userSearchEmail')->name('email.search');

        Route::get('user/password/{id}', 'AdminUserController@passwordSetting')->name('user.password');
        Route::put('user/updatePassword/{id}', 'AdminUserController@updatePassword')->name('user.pass-update');

        Route::get('/user/balance/{id}', 'AdminUserController@indexUserBalance')->name('user.balance');
        Route::post('user/balance/{id}', 'AdminUserController@indexBalanceUpdate')->name('user.balance.update');

        Route::get('/user/mail/{id}', 'AdminUserController@userSendMail')->name('user.email');
        Route::post('user/send/mail', 'AdminUserController@userSendMailUser')->name('send.mail.user');
        ...
        Route::post('/events/{id}/update', 'BettingController@updateMatch')->name('admin.update.match');
