...
class TicketController extends Controller
{
    ...
    {
        $data['page_title'] = 'Adicionar Novos Tickets';
        $data['user'] = Auth::user();
    ...
    public function ticketStore(Request $request)
    {
        ...
        return redirect()->route('ticket.user.reply', $support->ticket)->with('message', 'Mensagem enviada com sucesso');
    }
    ...
    public function ticketClose($support)
    {
        ...
        return redirect()->back()->with('message', 'Conversa encerrada, mas você pode começar novamente');
    }

    public function ticketReply($support)
    {
        $data['page_title'] = "Responder ao Suporte";
