...
class BettingController extends Controller
{
    ...
    public function refundBetInvest(Request $request)
    {
        ...
        foreach ($winners as $winner) {
            ...
            $msg = "Reembolsado pela política do administrador." . "\n Evento: " . $match->name . " ( Pergunta: " . $betQ->question . " => " . $winner->betoption->option_name . ")";
    ...
    public function refundBetInvestSingleUser(Request $request)
    {
        ...
        $msg = "Reembolsado pela política do administrador." . "\n Evento: " . $mm->name . " ( Pergunta: " . $invest->ques->question . " => " . $invest->betoption->option_name . ")";
    ...
    public function makeWinner(Request $request)
    {
        ...
        foreach ($winner as $data) {
            ...
            $msg = "Evento: " . $data->match->name . " - Pergunta: " . $data->ques->question . ", Opção: " . $data->betoption->option_name . " => Vitória";
